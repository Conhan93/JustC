...
UserInterface::UserInterface(Admin state_admin)
{
  this->Scanner = ReadInput();
  this->admin = state_admin;
}
void UserInterface::main_loop(STATE* SYSTEM_STATE)
{
  int selection = 0;
...
void UserInterface::list_cards(STATE* SYSTEM_STATE)
{
...
void UserInterface::change_card_access(STATE* SYSTEM_STATE)
{
    /*
...
Card* UserInterface::search_id(STATE* SYSTEM_STATE)
{
